...
#   ^^^^^
    NO256__COLOR_LEFTHEADER_FG_FROM=$( tput setf 0   || tput setaf 0   || : 2>/dev/null ) ; # BLACK     (0)
          __COLOR_LEFTHEADER_FG_FROM=$( tput setf 25  || tput setaf 25  || : 2>/dev/null ) ; # MediumPurple4 (60)
...
NO256__COLOR_LEFTHEADER_FG_FROMSEP=$( tput setf 7   || tput setaf 7   || : 2>/dev/null )      ; # WHITE     (7)
      __COLOR_LEFTHEADER_FG_FROMSEP=$( tput setf 250 || tput setaf 250 || : 2>/dev/null )      ; # Grey93    (255)
...
NO256__COLOR_RIGHTHEADER_FG_TYPESEP=$( tput setf 7   || tput setaf 7   || : 2>/dev/null )  ; # WHITE     (7)
      __COLOR_RIGHTHEADER_FG_TYPESEP=$( tput setf 250 || tput setaf 250 || : 2>/dev/null )  ; # Grey93    (255)
...
#                                      ^
    NO256__COLOR_RIGHTHEADER_FG_SEP=$( tput setf 7   || tput setaf 7   || : 2>/dev/null )  ; # WHITE     (7)
          __COLOR_RIGHTHEADER_FG_SEP=$( tput setf 255 || tput setaf 255 || : 2>/dev/null )  ; # Grey93    (255)
